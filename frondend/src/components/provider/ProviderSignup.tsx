    ...
    <div className="flex h-screen items-center justify-center bg-gray-100">
      <div className="flex w-full max-w-2xl overflow-hidden rounded-lg shadow-lg bg-white">
        ...
        <div
          ...
          style={{ backgroundImage: `url('/images/provider.webp')` }} // Ensure the path to the image is correct
        >
        ...
        <div className="w-full sm:w-1/2 p-6">
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-600">
              Already have an account?{' '}
              <a href="/provider/login" className="text-red-600 font-bold hover:text-red-500">
                Sign In
              </a>
            </p>
          </div>
