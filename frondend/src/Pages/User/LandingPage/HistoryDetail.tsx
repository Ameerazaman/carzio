...
// import { cancelBookingByUser, specificBookingDetails } from '../../../Api/User';
...
//                         bookingHistory?.total_Amt // No trailing comma here
//                     );
...
import { Booking } from '../../../Interface/BookinDetailsInterface';
import { cancelBookingByUser, checkBookidInReview, specificBookingDetails } from '../../../Api/User';
import ReviewModal from './ReviewModal';
// Create this component for the modal
                ...
                try {
                    ...
                    if (result.data.data.status === "Completed") {
                        ...
                        if (!result.data.success) {
                            setIsReviewModalOpen(true); // Open modal if status is "Completed"
                        }
                    }
