...
// const ChatPage: React.FC<ChatProps> = ({ senderId, recieverId, username }) => {
...
//             const response = await fetchChat(senderId, recieverId);
...
//         socket.on(`receive_message_${senderId}`, (newMessage: Message) => {
//             setChatHistory((prev) => [...prev, newMessage]);
//         });

//         return () => {
//             socket.off(`receive_message_${senderId}`);
//         };
//     }, [senderId, recieverId]);
...
//                     <div
//                         key={index}
//                         className={`chat-bubble p-3 rounded-lg max-w-xl text-sm ${chat.senderId === senderId
//                             ? "bg-blue-100 text-gray self-end" // Light blue background for user's message
//                             : "bg-gray-150 text-gray-800 self-start"
//                             }`}
//                     >
//                         <p>{chat.message}</p>
