  ...
  return (
    <div className="bg-gray-900 text-white w-64 h-screen p-4 shadow-lg">
      ...
      <ul className="space-y-4">
        ...
        <li>
          <a href="/provider/dashboard"className="flex items-center p-2 hover:bg-red-600 rounded transition duration-200">
            <FaCog className="mr-2" />
            Dashboard
          </a>
        </li>
        <li>
          <a href="/provider/booking" className="flex items-center p-2 hover:bg-red-600 rounded transition duration-200">
