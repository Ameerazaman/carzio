...
const ProviderDashboard: React.FC = () => {
    ...
    const reveueDoughnutData = {
        ...
        datasets: [
            {
                label: 'Total revenue',
                data: [totalRevenue], // Use the fallback value
        ...
        <div className="dashboard-container p-6 bg-white rounded-lg shadow-lg">
            ...
            <div className="flex space-x-8 mb-6">
                ...
                <div className="stat-item text-center flex-1">
                    ...
                    <Doughnut data={carDoughnutData} options={doughnutOptions} height={20} width={20} />
                </div>
                <div className="stat-item text-center flex-1">
                    <h3 className="text-xl font-semibold">Total Car Bookings</h3>
                    <div className="text-3xl text-yellow-500">{carBookingTotal}</div>
                    <Doughnut data={carBookingDoughnutData} options={doughnutOptions} height={20} width={20} />
                </div>
                <div className="stat-item text-center flex-1">
                    <h3 className="text-xl font-semibold">Total Revenue</h3>
                    <div className="text-3xl text-green-500">{totalRevenue.toLocaleString()}</div>
                    <Doughnut data={reveueDoughnutData} options={doughnutOptions} height={20} width={20} />
                </div>
