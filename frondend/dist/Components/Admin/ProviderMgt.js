...
function ProviderMgt() {
    ...
    var limit = 10;
    var header = 'provider'; // Define whether this is for users or providers
    useEffect(function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        setLoading(true);
                        return [4 /*yield*/, providerManagement(page, limit)];
                    case 1:
                        result = _b.sent();
                        console.log(result === null || result === void 0 ? void 0 : result.data, 'Fetched provider data');
