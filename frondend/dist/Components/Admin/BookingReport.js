...
function CarsMgt() {
    ...
    var limit = 10;
    var header = 'cars'; // Define whether this is for users or providers
    useEffect(function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        setLoading(true);
                        return [4 /*yield*/, carManagementt(page, limit)];
                    case 1:
                        result = _b.sent();
    ...
    return (_jsxs("div", { className: "flex", children: [_jsx(Sidebar, {}), _jsxs("div", { className: "flex-1 flex flex-col", children: [_jsx(Navbar, {}), _jsxs("div", { className: "flex-1 p-6 bg-gray-100", children: [_jsx("h1", { className: "text-2xl font-bold mb-4", children: "Car Management" }), _jsx("div", { className: "flex-1 bg-white rounded-lg shadow-md", children: loading ? (_jsx("p", { className: "text-center py-4", children: "Loading..." })) : error ? (_jsx("p", { className: "text-center py-4 text-red-600", children: error })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "overflow-x-auto max-w-full", children: _jsx(Table, { tableData: tableData, header: header }) }), _jsx(Pagination, { currentPage: page, totalPages: totalPages, onPageChange: handlePageChange })] })) })] })] })] }));
}
