...
var ProviderOtp = function () {
    var dispatch = useDispatch();
    var _a = useState(50), timer = _a[0], setTimer = _a[1];
    var _b = useState(true), isTimerActive = _b[0], setIsTimerActive = _b[1];
    var _c = useState(Array(6).fill('')), otp = _c[0], setOtp = _c[1];
    ...
    var handleResendOtp = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    error_1 = _c.sent();
                    console.error('Error resending OTP:', error_1);
