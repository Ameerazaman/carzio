...
function CarMgt() {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        setLoading(true);
                        setError(null);
                        if (!(provider === null || provider === void 0 ? void 0 : provider._id)) return [3 /*break*/, 2];
                        return [4 /*yield*/, carManagement(provider === null || provider === void 0 ? void 0 : provider._id, page, limit)];
                    case 1:
                        result = _b.sent();
    ...
    return (_jsxs("div", { className: "flex flex-col h-screen", children: [_jsx(Navbar, {}), _jsxs("div", { className: "flex flex-grow", children: [_jsx(Sidebar, {}), _jsx("div", { className: "flex-1 p-6 bg-gray-100 overflow-y-auto", children: _jsx("div", { className: "overflow-x-auto bg-white rounded-lg shadow-md", children: loading ? (_jsx("p", { className: "text-center py-4", children: "Loading..." })) : tableData.length === 0 ? (_jsxs("div", { className: "flex flex-col items-center justify-center min-h-[300px]", children: [_jsx("div", { className: "w-32 h-32 bg-gray-200 rounded-full flex items-center justify-center animate-bounce", children: _jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-16 w-16 text-gray-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M3 10h18M9 21V10m6 0v11M5 10L5 5a2 2 0 012-2h10a2 2 0 012 2v5" }) }) }), _jsx("p", { className: "text-gray-600 mt-4 text-lg font-semibold", children: "No cars found." }), _jsx("p", { className: "text-gray-500 text-sm", children: "Add your first car to see it here." })] })) : (_jsxs(_Fragment, { children: [_jsx(CarMgtTable, { tableData: tableData }), _jsx(Pagination, { currentPage: page, totalPages: totalPages, onPageChange: handlePageChange })] })) }) })] })] }));
}
