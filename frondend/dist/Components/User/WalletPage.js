...
function WalletPage() {
    ...
    return (_jsxs("div", { children: [_jsx(Navbar, {}), loading ? (_jsx("div", { className: "text-center text-lg text-gray-500", children: _jsx(Loading, {}) })) : walletData && walletData.length > 0 ? (_jsxs(_Fragment, { children: [_jsx("br", {}), _jsx("div", { className: "text-center flex flex-col items-center space-y-4", children: _jsxs("h2", { className: "text-xl font-bold bg-gradient-to-r from-yellow-400 to-red-500 bg-clip-text text-transparent animate-pulse", children: ["Total Wallet Balance:", " ", _jsx("span", { className: "text-3xl font-extrabold", children: "\u20B9".concat(total.toFixed(2)) })] }) }), _jsx(WalletTable, { walletData: walletData }), _jsx(Pagination, { currentPage: page, totalPages: totalPages, onPageChange: handlePageChange })] })) : (_jsxs("div", { className: "flex items-center justify-center min-h-screen flex-col", children: [_jsx("div", { className: "text-2xl font-semibold text-gray-600 mb-4 animate-pulse", children: "Your wallet is empty" }), _jsx("div", { className: "w-40 h-40 bg-gray-200 rounded-full flex items-center justify-center animate-bounce", children: _jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "w-20 h-20 text-gray-400", viewBox: "0 0 20 20", fill: "currentColor", children: _jsx("path", { fillRule: "evenodd", d: "M4 3C4 2.44772 4.44772 2 5 2H15C15.5523 2 16 2.44772 16 3V17C16 17.5523 15.5523 18 15 18H5C4.44772 18 4 17.5523 4 17V3ZM5 4V16H15V4H5ZM6 6H14V7H6V6Z", clipRule: "evenodd" }) }) }), _jsx("p", { className: "text-lg text-gray-500 mt-4 animate-fade-in", children: "Looks like you haven't made any transactions yet. Start adding funds to your wallet to see your balance here!" })] })), _jsx("div", { className: "mt-12", children: _jsx(Footer, {}) })] }));
}
